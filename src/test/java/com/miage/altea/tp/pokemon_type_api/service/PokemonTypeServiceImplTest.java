...
import com.miage.altea.tp.pokemon_type_api.repository.impl.TranslationRepositoryImpl;
...
class PokemonTypeServiceImplTest {
    ...
    void pokemonNames_shouldBeTranslated_usingLocaleResolver() {
        ...
        when(pokemonTypeRepository.findPokemonTypeById(25)).thenReturn(pokemonType);
